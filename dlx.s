...
calculoMatriz:                                      ; calculo de la matriz aqui se usan los registros f6,f7,f8,f9
    ...
    j       saveMatriz,     ;,              salto,  auxiliar,para,guardar,los,valores,en,memoria; salto auxiliar para guardar los valores en memoria;
calculoMedia:
    addf    f15,            f14,            f1      ; intentamos eliminar el stall de lectura f15=4+0
    addf    f10,            f7,             f8
    addf    f11,            f9,             f6
    addf    f12,            f10,            f11     ; obtenemos la suma de todos los elementos de la matriz
    divf    f13,            f10,            f15     ; obtenemos la media de la matriz
    j       saveMedia                               ; salto auxiliar para guardar los valores en memoria
saveMatriz:
